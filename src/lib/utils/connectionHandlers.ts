 ...
 */
export function findClosestConnectionPoint(position: Position, connectionPoints: ConnectionPoint[]): ConnectionPoint | null {
 ...
 */
export function handleConnectionStart(sourcePoint: ConnectionPoint) {
  return { sourcePoint };
}
 ...
 */
export function handleConnectionComplete(
  sourcePoint: ConnectionPoint,
  targetPoint: ConnectionPoint,
  elements: BpmnElementUnion[]
 ...
 */
export function getAllConnectionPoints(elements: BpmnElementUnion[]): ConnectionPoint[] {
