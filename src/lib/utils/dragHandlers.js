 ...
 */
export function handleDragStart(element, event) {
 ...
 */
export function calculateDragPosition(originalPos, mousePos, event) {
 ...
 */
export function handleElementDrop(event, canvasRect, viewportX, viewportY) {
