...
export class ElementInteractionManager {
    constructor(elementManagerComponent = null) {
        this.elementManagerComponent = elementManagerComponent;
        // Dragging state
        this.isDragging = writable(false);
        this.draggedElementId = writable(null);
        this.dragStartX = writable(0);
        this.dragStartY = writable(0);
        this.originalPositions = writable({});
        // Element selection state
        this.selectedElementId = writable(null);
        // Derived stores for external components
        this.draggingState = derived([this.isDragging, this.draggedElementId], ([$isDragging, $draggedElementId]) => ({
     ...
     */
    setElementManagerComponent(component) {
